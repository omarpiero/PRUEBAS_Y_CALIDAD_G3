# 10. Anexos de macroprocesos

Fecha de cierre: 2026-06-27  
Objetivo: asegurar que los macroprocesos exigidos por el informe final queden ubicados, descritos y listos para insertar como anexos.

## Macroprocesos del LMS
...
| Anexo | Contenido | Nota de insercion |
| --- | --- | --- |
| Anexo C.1 | MP-01 y MP-02 | Procesos internos de administracion. |
| Anexo C.2 | MP-03 y MP-08 | Control, auditoria y gestion estrategica. |
| Anexo C.3 | MP-04, MP-05 y MP-06 | Flujo principal del estudiante y cadena de valor. |
| Anexo C.4 | MP-07 | Soporte inteligente con Gemini y derivacion humana. |

## Checklist de cierre

- [ ] Insertar las 8 imagenes BPMN en el Word final.
- [ ] Verificar que cada figura tenga titulo, fuente y numeracion.
- [ ] Confirmar que los nombres de macroprocesos coinciden con Capitulo 4 y Anexo C.
- [ ] Evitar rutas locales visibles en el informe final.
- [ ] Exportar el Word a PDF y revisar que las imagenes no queden cortadas.

## Criterio de aceptacion

El anexo queda completo cuando cada macroproceso tiene imagen visible, descripcion breve, actor responsable y relacion con al menos un controlador, ruta o modelo del codigo.
